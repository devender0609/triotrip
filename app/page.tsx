...
type SubTab = "explore" | "savor" | "misc"; // used to drive ExploreSavorTabs via mode
    ...
    <div style={{ padding: 12, display: "grid", gap: 14 }}>
      ...
      {showControls && (
        <>
          ...
          >
            {/* Show only the active group now */}
            <ExploreSavorTabs
      ...
      {/* COMPARE TRAY (appears when 2+ selected) */}
