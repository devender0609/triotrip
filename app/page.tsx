...
export default function Page() {
  ...
  return (
    <div style={{ padding: 12, display: "grid", gap: 14 }}>
      <form style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 16, padding: 16, display: "grid", gap: 14 }}
        ...
        <div style={{ display: "grid", gap: 12, gridTemplateColumns: "1fr 1fr 1fr 1fr" }}>
          ...
          <div style={{ textAlign: "right" }}>
            <button type="submit" style={{ padding: "10px 16px", borderRadius: 12, border: "1px solid #CBD5E1", background: "#0ea5e9", color: "#fff", fontWeight: 800, marginTop: 8 }}>
      ...
      {/* Unlimited compare: show tray if 2+ selected; no cap */}
      {comparedIds.length >= 2 && (
        <ComparePanel
          items={shown?.filter(r => comparedIds.includes(String(r.id || ""))) ?? []}
          currency={currency}
